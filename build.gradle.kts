...
dependencies {
    ...
    implementation(group = "net.flintmc.installer", name = "logic-implementation", version = "2.0.1")
    implementation(group = "net.flintmc.installer", name = "frontend-gui", version = "2.0.1")
    implementation(group = "net.flintmc.installer", name = "logic", version = "2.0.1")
    implementation(group = "net.flintmc.installer", name = "logic-implementation", version = "2.0.1")
    implementation(group = "net.flintmc.installer", name = "logic", version = "2.0.1")
