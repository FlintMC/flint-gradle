...
public class JavaPluginInteraction {
     ...
     * Versioned setup is handled by the {@link #setupVersioned(LabyfyGradleExtension, Collection, Collection, String)}
     * method.
     *
     * @param extension The configured extension
     */
    public void setup(LabyfyGradleExtension extension) {
    ...
    public void setupVersioned(
            LabyfyGradleExtension extension,
